        ...
        <div className="w-full flex flex-col lg:flex-row justify-between gap-8 relative">
          ...
          <div className="lg:w-full flex-1 max-w-5xl pl-32">
            <div className="max-w-4xl">
              <h1 className="text-4xl md:text-3xl xl:text-4xl 2xl:text-5xl font-bold">
                {post?.title}
              </h1>
          ...
          <div className="w-full lg:w-[300px] h-max sticky top-20 px-3 pb-5">
            <div>
              <h2 className="text-sm font-semibold mb-1">
                <mark className="bg-purple-400 text-black">Author</mark>
              </h2>
      ...
      <div className="mt-5 px-4 gap-10 lg:w-3/5 ml-24">
        ...
        <div className="flex items-center justify-between gap-8 w-full mt-3">
          <textarea
            ...
            className="w-full p-4 rounded-xl mt-4 mb-14"
            value={comment.content}
            onChange={(event) => setComment({ content: event.target.value })}
          ></textarea>
          <button
            className="btn btn-primary bg-black px-4 py-3 font-normal rounded-xl"
            onClick={submitPost}
          >
            send
          </button>
        ...
        {post &&
          post?.comments?.map((c) => (
            <div
              key={c.id}
              className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm flex gap-3 mt-4 mb-8"
            >
