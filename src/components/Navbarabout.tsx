    ...
    <header className="sticky top-0 backdrop-blur-sm z-20">
      <div className="py-5 px-20">
        <div className="flex items-center justify-between">
          ...
          >
            <Link href="/" className="block md:inline-block px-4 py-2 text-white hover:text-gray-400 hover:scale-125 transition-all ease-in-out">Explore</Link>
            <Link href="/about" className="block md:inline-block px-4 py-2 text-white hover:text-gray-400 hover:scale-125 transition-all ease-in-out">About</Link>
            <Link href="/feed" className="block md:inline-block px-4 py-2 text-white hover:text-gray-400 hover:scale-125 transition-all ease-in-out">Home</Link>
            <Link href="/help" className="block md:inline-block px-4 py-2 text-white hover:text-gray-400 hover:scale-125 transition-all ease-in-out">Help</Link>
